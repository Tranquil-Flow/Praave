...
import { AaveWithdrawStep, AaveReturnLoanStep } from '../steps/aave';
import { BigNumberish, ethers } from 'ethers';

export class AaveRepayRecipe extends Recipe {
    readonly config: RecipeConfig = {
        name: 'Aave Repay',
        description:
            'Returns DAI into Aave Pool and withdraws WETH'
    };
    ...
    protected async getInternalSteps(
        ...
        const wethWithdrawAmount = 0; // TO-DO: Take input from front end and plug in here
        ...
        return [
          ...
          new AaveReturnLoanStep(dai, daiRepayAmount, interestRateMode, onBehalfOf),
          new AaveWithdrawStep(weth, wethWithdrawAmount, onBehalfOf),
        ];
      }
